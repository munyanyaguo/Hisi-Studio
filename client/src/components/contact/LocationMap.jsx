        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-gray-50 to-white">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    {/* Map - Boxy */}
                    <div className="relative overflow-hidden shadow-2xl h-[400px] lg:h-[500px]">
                        <iframe
                        ...
                        {/* Overlay with Get Directions button - Boxy */}
                        <div className="absolute bottom-4 left-4 right-4">
                            <a
                                href="https://www.google.com/maps/dir//Westlands,+Nairobi"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="flex items-center justify-center space-x-2 bg-white hover:bg-hisi-primary text-gray-900 hover:text-white font-semibold px-6 py-3 shadow-lg hover:shadow-xl transition-all duration-300 w-full"
                            >
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-white p-6 shadow-lg hover:shadow-xl transition-shadow duration-300">
                            <div className="flex items-start space-x-4">
                                <div className="w-12 h-12 bg-hisi-primary/10 flex items-center justify-center flex-shrink-0">
                        ...
                        {/* Accessibility Features Card - Boxy */}
                        <div className="bg-gradient-to-br from-hisi-primary/5 to-hisi-accent/5 p-6 border-2 border-hisi-primary/20">
                            <div className="flex items-start space-x-4">
                                ...
                                <div>
                                    ...
                                    <ul className="space-y-2 text-sm text-gray-700">
                                        <li className="flex items-center space-x-2">
                                            <span className="w-1.5 h-1.5 bg-hisi-primary"></span>
                        ...
                        {/* Book Appointment CTA - Boxy */}
                        <button
                            onClick={() => {
                                const bookingSection = document.getElementById('booking-system')
                                bookingSection?.scrollIntoView({ behavior: 'smooth' })
                            }}
                            className="w-full bg-gradient-to-r from-hisi-primary to-hisi-accent text-white font-semibold py-4 px-6 hover:shadow-lg transform hover:-translate-y-0.5 transition-all duration-300"
                        >
                            Book an Appointment
                        </button>
                    </div>
